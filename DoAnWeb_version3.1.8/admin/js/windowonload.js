function layur(){
	...
	if(pagrams.length == 1) //index.html
	{
		var s = '';
		s = s 
	+'<div id="title">'
		...
		+'<div class="col-4">'
			+'<div class="row user-progress">'
				+'<div class="title-progress">'
					+'<div class="left-title">Sách Tiếng Việt</div>'
			...
			+'<div class="row user-progress">'
				+'<div class="title-progress">'
					+'<div class="left-title">Sách Tiếng Anh</div>'
			...
			+'<div class="row user-progress">'
				+'<div class="title-progress">'
					+'<div class="left-title">Sách Thiếu Nhi</div>'
			...
			+'<div class="row user-progress">'
				+'<div class="title-progress">'
					+'<div class="left-title">Sách Giáo Khoa</div>'
	...
	document.getElementById("content").innerHTML = s;
		...
		s = s 
		+'<tr>'
			+'<td colspan="2">Ngày từ: <input type="date" name="">Ngày đến: <input type="date" name=""></td>'
			+'<td colspan="4">'
				+'Trạng thái'
				+'<select>'
...
function chitietsp(vitri){
	document.getElementsByClassName('overplay')[2].style.display = 'block'
	var obj = JSON.parse(localStorage.getItem("order-"+vitri));
	var s = '';
	...
	document.getElementById("chitiet").innerHTML = s;
}
...
function tinhtrangdonhang(vitri)
{
	var obj = JSON.parse(localStorage.getItem("order-"+vitri));
	if(obj.xuli == 0){
		obj.xuli = 1;
	...
	localStorage.setItem("order-"+vitri,JSON.stringify(obj));
	window.location.assign("index.html?donhang");
}	
function closepopup()
{
...
{
	document.getElementById("key_danh_muc").value = danhmuc[key].key;
	document.getElementById("ten_danh_muc").value = danhmuc[key].name;
...
function luudanhmuc(key){
	document.querySelectorAll("tr#tr"+key+' td')[0].innerText = document.getElementById("key_danh_muc").value;
	document.querySelectorAll("tr#tr"+key+' td')[1].innerText = document.getElementById("ten_danh_muc").value;
	closepopup();
}
